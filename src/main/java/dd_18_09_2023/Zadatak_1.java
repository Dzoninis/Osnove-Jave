...
//    U glavnom programu kreirati video plejer i izvrsiti neke akcije nad njim.
        ...
        VideoPlayer video_1 = new VideoPlayer(224, 188, 38, 20);

        TimeControl kontrol_1 = new TimeControl(true);
        AudioControl audio_1 = new AudioControl(false);
        QualityOptimizerControl quality_1 = new QualityOptimizerControl(20);

        video_1.stampajVideo();
        System.out.println();

        kontrol_1.izvrsiAkciju(video_1);
        audio_1.izvrsiAkciju(video_1);
        audio_1.izvrsiAkciju(video_1);
        audio_1.izvrsiAkciju(video_1);
        quality_1.izvrsiAkciju(video_1);
